...
void draw_object_shadow(Collision*, Vec3f, f32);
void func_8004A6EC(s32, f32);
void func_8004A7AC(s32, f32);
void shadow_for_a_hedgehog(s32, f32);
...
void set_prim_only(s32, s32, s32, s32);
...
void set_shadow_color(u32, u32, u32, u32);
void set_trans_masked_color(u32, u32, u32);
void func_8004B4E8(s32, s32, s32, s32);
void func_8004B554(s32);
void func_8004B5A8(s32, s32, s32, s32);
void setup_tinted_transparent(u32, u32, u32, u32, u32, u32, u32);
...
void render_one_ia8_star_particle(s32, Vec3f);
void render_ia8_star_particles(s32);
...
void render_a_hedgehog(s32, s32);
