...
s16 move_along_path(Vec3f, s16*, f32, f32, s16, s16);
...
s32 generate_smoothed_course_path(TrackPathPoint*, TrackPathPoint*, s32, s32);
...
extern uint8_t gIsPlayerInCurve[];
