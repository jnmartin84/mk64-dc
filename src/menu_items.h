...
void adjust_img_colour(s32, s32, u32, u32, u32);
...
void menu_item_ceremony_cup_cc_render(MenuItem*);
void menu_item_ceremony_awarded_render(MenuItem*);
void menu_item_ceremony_greeting_render(MenuItem*);
void menu_item_ceremony_placed_render(MenuItem*);
...
extern char* gEraseBestGhostText[][3];
...
extern MenuTexture* gMenuTexturesCoursePreview[];
extern MenuTexture* gMenuTexturesCourseTitle[];
