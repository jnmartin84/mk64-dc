...
uint8_t is_within_horizontal_distance_of_player(s32, Player*, f32);
s32 are_between_distance_2d(s32, Player*, f32, f32);
uint8_t is_within_distance_to_player(s32, Player*, f32);
uint8_t is_within_horizontal_distance_to_camera(s32, Camera*, f32);
UNUSED uint8_t is_within_bounds_to_camera(s32, Camera*, f32, f32);
uint8_t is_within_distance_to_camera(s32, Camera*, f32);
uint8_t has_collided_horizontally_with_player(s32, Player*);
uint8_t has_collided_with_player(s32, Player*);
uint8_t has_collided_with_player_1d(s32, Player*, f32);
uint8_t has_collided_with_player_and_within_height(s32, Player*, f32);
f32 func_80088F54(s32, Player*);
UNUSED uint8_t func_80088F94(s32, Player*, f32);
...
uint8_t is_object_visible_on_camera(s32, Camera*, u16);
