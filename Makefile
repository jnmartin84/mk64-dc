...
ifeq ($(TARGET_DC),1)
  TARGET_CFLAGS := -DGBI_FLOATS -fno-strict-aliasing -Wall -Os -DTARGET_DC -D_LANGUAGE_C -DTARGET_DC -D_LANGUAGE_C -isystem GLdc/include -Iinclude -Ibuild/us -Ibuild/us/include -Isrc -Isrc/racing -Isrc/ending -I. -DVERSION_US=1 -DF3DEX_GBI=1 -DF3D_OLD=1 -D_LANGUAGE_C=1 -DNON_MATCHING=1 -DAVOID_UB=1 -DAVOID_UB=1 -DGCC=1 -Wall -Wextra -DENABLE_OPENGL -Os -Wno-incompatible-pointer-types -Wno-int-conversion -g1 -fno-toplevel-reorder -fwrapv -Wstrict-overflow=2
  CC_CFLAGS :=
endif
...
LIBGL := GLdc/build/libGL.a
$(LIBGL):
	-mkdir GLdc/build
	kos-cmake -S GLdc -B GLdc/build -DCMAKE_BUILD_TYPE=release -DBUILD_SAMPLES=OFF -DBUILD_TESTS=OFF
	cmake --build GLdc/build
